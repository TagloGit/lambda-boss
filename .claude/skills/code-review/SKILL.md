...
1. Read the PR: `gh pr view <number> -R TagloGit/lambda-boss --json title,body,url`
2. Find the linked issue from the PR body (look for "Closes #N")
3. Read the issue: `gh issue view <number> -R TagloGit/lambda-boss --json title,body`
4. If the issue references a spec or plan, read those files
5. Review the diff: `gh pr diff <number> -R TagloGit/lambda-boss`
6. Assess:
